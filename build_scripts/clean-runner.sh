...
rm -rf ../venv || true
rm -rf venv || true
rm -rf skynet_blockchain.egg-info || true
rm -rf build_scripts/final_installer || true
rm -rf build_scripts/dist || true
rm -rf build_scripts/pyinstaller || true
rm -rf skynet-blockchain-gui/build || true
rm -rf skynet-blockchain-gui/daemon || true
rm -rf skynet-blockchain-gui/node_modules || true
rm skynet-blockchain-gui/temp.json || true
( cd "$PWD/skynet-blockchain-gui" && git checkout HEAD -- package-lock.json ) || true
cd "$PWD" || true
...
npm uninstall -g @skynet-network/notarize-cli || true
