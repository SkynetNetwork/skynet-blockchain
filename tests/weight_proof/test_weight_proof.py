...
from skynet.server.start_full_node import SERVICE_NAME
...
from skynet.consensus.pot_iterations import calculate_iterations_quality
from skynet.full_node.weight_proof import (
    WeightProofHandler,
