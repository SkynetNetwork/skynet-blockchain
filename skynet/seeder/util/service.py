...
from skynet.daemon.server import pid_path_for_service
...
def launch_service(root_path: Path, service_command) -> Tuple[subprocess.Popen, Path]:
    ...
    print(f"Launching service with SKYNET_ROOT: {os.environ['SKYNET_ROOT']}")
...
if getattr(sys, "frozen", False):
    name_map = {
        ...
        "skynet_seeder_server": "skynet_seeder_server",
    }
