...
from skynet.util.condition_tools import conditions_dict_for_solution
    ...
    try:
        ...
        for coinsol in trade_offer.coin_spends:
            ...
            if r:
                ...
                if "skynet" in cc_discrepancies:
                    cc_discrepancies["skynet"] = cc_discrepancies["skynet"] + diff
                else:
                    cc_discrepancies["skynet"] = diff
