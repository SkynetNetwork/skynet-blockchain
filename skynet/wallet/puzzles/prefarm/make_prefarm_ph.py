...
from skynet.util.condition_tools import parse_sexp_to_conditions
from skynet.util.ints import uint32

address1 = "xnt15gx26ndmacfaqlq8m0yajeggzceu7cvmaz4df0hahkukes695rss6lej7h"  # address1 wallet (m/12381/8444/2/42)
address2 = "xnt1c2cguswhvmdyz9hr3q6hak2h6p9dw4rz82g4707k2xy2sarv705qcce4pn"  # address2 address (m/12381/8444/2/0)
...
def make_puzzle(amount: int) -> int:
    ...
    if error:
        ...
        for cvp in result_human:
            ...
            total_skynet += int_from_bytes(cvp.vars[1])
...
total_skynet = 0
print("Pool address: ")
total_skynet += make_puzzle(pool_amounts)
print("\nFarmer address: ")
total_skynet += make_puzzle(farmer_amounts)

assert total_skynet == calculate_base_farmer_reward(uint32(0)) + calculate_pool_reward(uint32(0))
