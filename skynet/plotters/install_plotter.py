import os
from skynet.plotters.bladebit import install_bladebit
from skynet.plotters.madmax import install_madmax


def install_plotter(plotter, root_path):
    if plotter == "skynetpos":
        print("Skynetpos already installed. No action taken.")
        return
    elif plotter == "madmax":
        if not os.path.exists(root_path / "madmax-plotter/build/skynet_plot"):
