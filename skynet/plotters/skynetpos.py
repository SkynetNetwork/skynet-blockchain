"""
NOTE: This contains duplicate code from `skynet.cmds.plots`.
After `skynet plots create` becomes obsolete, consider removing it from there.
"""
import asyncio
import logging
import pkg_resources
from skynet.plotting.create_plots import create_plots, resolve_plot_keys
...
def get_skynetpos_install_info() -> Optional[Dict[str, Any]]:
    skynetpos_version: str = pkg_resources.get_distribution("skynetpos").version
    return {"display_name": "Skynet Proof of Space", "version": skynetpos_version, "installed": True}
...
def plot_skynet(args, root_path):
