...
from skynet.util.config import load_config, save_config, str2bool
...
def configure(
    ...
    if testnet:
        if testnet == "true" or testnet == "t":
            ...
            testnet_dns_introducer = "dns-introducer-testnet10.skynet-network.org"
            testnet = "testnet_10"
    ...
    if change_made:
        print("Restart any running skynet services for changes to take effect")
