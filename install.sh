...
python -m pip install --extra-index-url https://pypi.skynet-network.org/v01/ miniupnpc==2.2.2
python -m pip install -e ."${EXTRAS}" --extra-index-url https://pypi.skynet-network.org/v01/

echo ""
echo "Skynet blockchain install.sh complete."
echo "For assistance join us on Keybase in the #support chat channel:"
echo "https://keybase.io/team/skynet_network.public"
echo ""
echo "Try the Quick Start Guide to running skynet-blockchain:"
echo "https://github.com/SkynetNetwork/skynet-blockchain/wiki/Quick-Start-Guide"
echo ""
echo "To install the GUI type 'sh install-gui.sh' after '. ./activate'."
echo ""
echo "Type '. ./activate' and then 'skynet init' to begin."
